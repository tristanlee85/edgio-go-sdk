...
// FilterList Filters the list of environments for a given Property by the environment name.
// Mandatory params:
// env.FilterParams.PropertyID
// Optional params:
// env.FilterParams.Name
// Returns a list of environments for a given Property that contain the provided name,
// or all environments if no name is provided.
